    ...
    public class CCK_CVRAvatarEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI() {
            ...
            if (_avatar.avatarUsesAdvancedSettings) {
                ...
                _avatar.avatarSettings.baseController =
                    (RuntimeAnimatorController) EditorGUILayout.ObjectField("Base Animator",
                                                                            _avatar.avatarSettings.baseController,
                                                                            typeof(RuntimeAnimatorController));

                EditorGUILayout
                    .HelpBox("This is the Base Animator that is extended for the creation of your Advanced Avatar Settings. " +
